...
const jornadas = {
  ...
  1: [["Don Pedrito Llamas ","Francisco  Caballero  (Cayayan)"],["Adrián Méndez  (Alemán)","Fernando (Pollo)"],["Erick Bernal","José Arteaga  (Comaye)"],["Alejandro Torres  (Alex)","Francisco Negrete   (Rioco)"],["Ranulfo Catalan (Chalan)","Amado Romero (El May)"],["Eduardo Rendon (Charro)","Gustavo Lozoya"],[" (Duende)","Julio Torres"],["Francisco Aguilar (MTTO.)","Israel Peña"],["Ginno López","Héctor Pineda  ( Cagochi )"],["Ginno López","Héctor Pineda  ( Cagochi )"],["Martín (Papis) x Rafa","Martín Barreto"],["Santos Chavez","Rubén Jimenéz  (Yogui)"]],
  2: [["Alex","Aleman"],["Barreto","Muertero"],["Charro","Rioco"],["Duende","La Comaye"],["Erick","Papis"],["Franc. MTT.","El May"],["Ginno","Lozoya"],["Pollo","July"],["Cagochi","Israel"]],
  3: [["Alex","Barreto"],["Charro","Aleman"],["Duende","Muertero"],["Erick","Rioco"],["Franc. MTT.","La Comaye"],["Ginno","Papis"],["Pollo","El May"],["Cagochi","Lozoya"],["Israel","July"]],
  4: [["Alex","Charro"],["Duende","Barreto"],["Erick","Aleman"],["Franc. MTT.","Muertero"],["Ginno","Rioco"],["Pollo","La Comaye"],["Cagochi","Papis"],["Israel","El May"],["July","Lozoya"]],
  5: [["Alex","Duende"],["Erick","Charro"],["Franc. MTT.","Barreto"],["Ginno","Aleman"],["Pollo","Muertero"],["Cagochi","Rioco"],["Israel","La Comaye"],["July","Papis"],["Lozoya","El May"]],
